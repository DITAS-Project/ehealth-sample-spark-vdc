...
scp -i  /opt/keypairs/ditas-testbed-keypair.pem  /home/cloudsigma/configurations/ehealth-sample-spark-vdc/.application.conf cloudsigma@31.171.247.162:.application.conf
