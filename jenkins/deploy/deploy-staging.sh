...
sudo docker exec -i ehealth-sample-spark-vdc sh -c 'cat > /app/ehealth-sample-spark-vdc-1.0-SNAPSHOT/conf/application.conf' < /home/cloudsigma/configurations/ehealth-sample-spark-vdc/.application.conf
