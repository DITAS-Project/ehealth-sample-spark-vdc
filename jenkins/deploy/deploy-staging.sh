...
sudo docker rm -f ehealth-sample-spark-vdc-da0.0.1 || true
sudo docker pull ditas/ehealth-sample-spark-vdc:da0.0.1
sudo docker run -p 50005:9000 -d --name ehealth-sample-spark-vdc-da0.0.1 ditas/ehealth-sample-spark-vdc:da0.0.1
ENDSSH
